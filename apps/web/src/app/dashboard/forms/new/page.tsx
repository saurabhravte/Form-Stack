...
export default function NewFormPage() {
  ...
  return (
    <div className="p-6 md:p-10 max-w-4xl mx-auto w-full">
      ...
      <h1 className="font-display text-3xl md:text-4xl font-bold mb-2">Create a new form</h1>
      <p className="text-muted-foreground mb-8">Give it a name and a theme — you can change everything later.</p>
      ...
      <div className="grid md:grid-cols-[1.4fr_1fr] gap-6">
              ...
              {themes.data?.map((t) => (
                <button
                  ...
                  className={`text-left p-3 rounded-md border transition-all ${
                    themeId === t.id ? 'border-primary ring-2 ring-primary/30' : 'border-border hover:border-foreground/30'
                  }`}
        ...
        <Card className="p-6">
          ...
          <p className="text-xs text-muted-foreground mb-4">Pre-filled with sensible fields you can edit.</p>
          <div className="flex flex-col gap-2">
            ...
            {templates.isLoading && <div className="text-xs text-muted-foreground">Loading templates…</div>}
          </div>
        </Card>
      </div>
    </div>
